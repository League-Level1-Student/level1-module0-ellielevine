...
public class FinishLine {
	...
	static boolean hasCrossedFinishLine() {
		if (rob.getY() < 200) {
			JOptionPane.showMessageDialog(null, "The robot has crossed the finsih line");
			JOptionPane.showMessageDialog(null, "Total distance robot traveled: " + totalDistance);
			return true;
		} else {
			JOptionPane.showMessageDialog(null, "The robot did not cross the finish line");
			JOptionPane.showMessageDialog(null, "Total distance robot traveled: " + totalDistance);
			return false;
		}
	}
