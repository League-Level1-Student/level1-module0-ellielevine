...
public class TooManyShapes {
	...
	public static void main(String[] args) {
		...
		boolean  makeShape = canMakeShape(numSides, numSides, calculateTurnAngle(numSides));
	...
	static boolean canMakeShape(int numSides, int numShapes, int degrees) {
		if (numSides >= 3) {
